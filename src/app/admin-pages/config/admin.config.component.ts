        ...
        <div class="layout-config" [ngClass]="{'layout-config-active': appMain.configActive}" (click)="appMain.onConfigClick($event)">
            ...
            <div class="layout-themes">
                <div *ngFor="let t of themes">
                    <a style="cursor: pointer" (click)="changeTheme(t)" [ngStyle]="{'background-color': t.color}">
                    </a>
                </div>
            </div>
        </div>
...
export class AdminConfigComponent implements OnInit {
    ...
    constructor(public appMain: AdminMainComponent, public app: AppComponent) {}
    ...
    changeTheme(theme: any) {
        ...
        this.app.color = theme.color;
        const layoutLink: HTMLLinkElement = document.getElementById('layout-css') as HTMLLinkElement;
        const layoutHref = 'assets/layout/css/layout-' + theme.name + '.css';

        this.replaceLink(layoutLink, layoutHref);

        const themeLink: HTMLLinkElement = document.getElementById('theme-css') as HTMLLinkElement;
        const themeHref = 'assets/theme/theme-' + theme.name + '.css';
