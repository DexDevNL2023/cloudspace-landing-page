...
import {AdminMenuComponent} from './admin-pages/menu/admin.menu.component';
import {AdminMenuitemComponent} from './admin-pages/menu/admin.menuitem.component';
import {AdminConfigComponent} from './admin-pages/config/admin.config.component';
import {AdminTopBarComponent} from './admin-pages/topbar/admin.topbar.component';
import {AdminFooterComponent} from './admin-pages/footer/admin.footer.component';
...
@NgModule({
    ...
    providers: [
        ...
        EventService, MenuService, MessageService, FooterDataService, HeaderDataService, HeroService, 
        DataService, WhatwedoService, ContactService, CareerService, AboutService, LoginService
    ],
